...
import { UploadCloud, X, Image as ImageIcon, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="page-container max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        {/* Image Upload */}
        <div>
          <label className="text-xs tracking-widest text-stone block mb-3">PRODUCT IMAGE</label>
          <div
            ...
            {imagePreview ? (
              ...
              <div className="aspect-video flex flex-col items-center justify-center gap-3 text-stone">
                ...
                <div className="text-center">
                  <p className="text-sm font-medium text-ink">Drop image here</p>
                  <p className="text-xs mt-1">or click to browse · PNG, JPG, WEBP up to 5MB</p>
                </div>
              </div>
            )}
          </div>
        ...
        {/* Title */}
        <div>
          <label className="text-xs tracking-widest text-stone block mb-2">PRODUCT TITLE</label>
          <input
            type="text"
            value={title}
            ...
            maxLength={120}
          />
          <p className="text-xs text-stone mt-1 text-right">{title.length}/120</p>
        </div>

        {/* Price */}
        <div>
          <label className="text-xs tracking-widest text-stone block mb-2">PRICE (USD)</label>
          <div className="relative">
            <span className="absolute left-0 top-1/2 -translate-y-1/2 text-stone text-sm pb-px">₹</span>
            <input
              type="number"
              value={price}
